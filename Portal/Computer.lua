    ...
    -- All credit to Direwolf20 :) Instructions:
    ...
    function fillTable()
       ...
       for turt, data in pairs(names) do
          ...
          for slot, name in pairs(data) do
           ...
           if currName > npp*(page-1) and currName < npp*page+1 then
             ...
             button.setTable(string.sub(name, 0, 17), runStuff, turt..":"..slot, col+offset1, col+17+offset1 , row, row)
             if col == 21 then
               col = 2
               countRow = countRow + 2
             else
       ...
       button.setTable("Next Page", nextPage, "", 21+offset2, 38+offset2, 1, 1)
       button.setTable("Prev Page", prevPage, "", 2+offset2, 19+offset2, 1, 1)
       button.setTable("Refresh", checkNames, "", 21-offset3, 38-offset3, 19, 19)
